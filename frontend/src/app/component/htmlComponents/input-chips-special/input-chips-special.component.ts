/**
 * This is our input chips special component, to be used through out our program
 */
import {
  AfterContentChecked,
  ChangeDetectorRef,
 ...
 */
@Component({
  selector: "app-input-chips-special",
  templateUrl: "./input-chips-special.component.html",
  styleUrls: ["./input-chips-special.component.css"],
})
export class InputChipsSpecialComponent
