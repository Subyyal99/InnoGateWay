...
@Component({
  selector: "app-t-sent-message",
  templateUrl: "./t-sent-message.component.html",
  styleUrls: ["./t-sent-message.component.css"],
})
export class TSentMessageComponent implements OnInit {
  tableHeaders = [
   ...
   */
  getSms() {
    this.Jarwis.getTelevotingSentMessage().subscribe(
