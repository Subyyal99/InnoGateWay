...
@Component({
  selector: "app-t-message-success",
  templateUrl: "./t-message-success.component.html",
  styleUrls: ["./t-message-success.component.css"],
})
export class TMessageSuccessComponent implements OnInit {
  tableHeaders = [
   ...
   */
  getSms() {
    this.Jarwis.getTelevotingSuccessfullMessage().subscribe(
