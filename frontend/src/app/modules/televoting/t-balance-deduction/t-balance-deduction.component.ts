...
@Component({
  selector: "app-t-balance-deduction",
  templateUrl: "./t-balance-deduction.component.html",
  styleUrls: ["./t-balance-deduction.component.css"],
})
export class TBalanceDeductionComponent implements OnInit {
  tableHeaders = [
   ...
   */
  getSms() {
    this.Jarwis.getTelevotingBalanceDeductionMessage().subscribe(
