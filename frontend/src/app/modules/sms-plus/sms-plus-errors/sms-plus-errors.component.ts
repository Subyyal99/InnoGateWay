...
@Component({
  selector: "app-sms-plus-errors",
  templateUrl: "./sms-plus-errors.component.html",
  styleUrls: ["./sms-plus-errors.component.css"],
})
export class SmsPlusErrorsComponent implements OnInit {
  tableHeaders = [
  ...
  /**
   * ngOnInIt is an angular lifecycle function that run when we load our component or application and call the function to get sms data
   */
  ngOnInit(): void {
    this.getSms();
  }
   ...
   */
  getSms() {
    this.Jarwis.getSmsPlusErrorMessage().subscribe(
