 ...
 */
@Component({
  selector: "app-balance-deduction",
  templateUrl: "./balance-deduction.component.html",
  styleUrls: ["./balance-deduction.component.css"],
})
export class BalanceDeductionComponent implements OnInit {
  tableHeaders = [
   ...
   */
  getSms() {
    this.Jarwis.getSmsPlusBalanceDeductionMessage().subscribe(
