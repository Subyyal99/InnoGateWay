 ...
 */
@Component({
  selector: "app-check-keyword",
  templateUrl: "./check-keyword.component.html",
  styleUrls: ["./check-keyword.component.css"],
})
export class CheckKeywordComponent implements OnInit {
  tableHeaders = [
   ...
   */
  getSms() {
    this.Jarwis.getSmsPlusCheckKeywordMessage().subscribe(
